...
const AdminDashboard = () => {
  return (
    <section className="mt-[5rem] pr-4 flex flex-col items-center justify-center w-[100%]">
      ...
      <article className="mt-[2rem] w-[100%] lg:w-[60%] border border-gray-400 mx-auto">
        ...
        <div className="flex items-center justify-between gap-1  md:gap-4 border-gray-500 border">
          ...
          <div className="flex flex-wrap gap-1 lg:gap-4 w-fit border-l border-l-gray-500 px-2 py-2">
            <Link to={'/registration-requests/all/'} className="bg-gray-700 text-white px-4 py-2 min-w-[100px] flex items-center justify-center rounded-sm">
              View
            </Link>
          </div>
        </div>
